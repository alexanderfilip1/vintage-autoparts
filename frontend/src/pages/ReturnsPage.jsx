        ...
        <main className="main-content">
          <section className="returns-section">
            ...
            <p className="returns-section__text">
              ...
              need to return an item, please follow our return process outlined
              below.
            </p>
            <h2 className="returns-section__subtitle">Return Process</h2>
            <p className="returns-section__text">
              To return an item, please contact our customer service team with
              your order number and reason for return. We will provide you with
